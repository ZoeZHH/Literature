...
Compared with other wildland fires, peat fires are more damaging because they comprise flaming and smouldering combustion (Che Azmi et al., 2021).

Flaming scorched the trees and consumed part of ground-covering vegetation, the smouldering fire burned the peat down and remove large quantities of the organic soil

The dominant smouldering combustion is flameless, slow-moving, and persistent combustion that can burn beneath the ground surface in wet conditions for long periods and is hard to extinguish (Bonn et al., 2016).

In pristine peatlands, most of the peat stock is protected from peat fires, resulting in the build-up of stored C. However, drainage and climate change are resulting in peatlands becoming more susceptible to fire.
