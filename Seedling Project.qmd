...
-   ***Manual Screening:** manually examining the time-series plots of gas concentrations for each chamber to determine the best fit between linear and exponential regressions by 1) checking visually and 2) selecting ones with lower rates of change of gas concentrations (dc/dt). Often, an exponential model provides the optimal fit for flux calculations.*
