...
Twelve additional collars (six for the seedling site and six for the seedling-removed site) were installed at the PSLS ecosystem site, supplementing the existing collars designated for aboveground biomass (AGB) analysis. Live AGB was measured by clipping the green parts of the vegetation within each collar in mid-June 2023. Sphagnum mosses were clipped at the base of their capitulum. The clipped plant samples were then air-dried at 60 ℃ for 48 hours and subsequently weighed, with the dry weights recorded in grams.
...
Rs contributions to Reco were 62.4% ± 3.5% and 66.8% ± 2.7% for seedling site and seedling removal site at PSLS ecosystem sites.
...
std_error_S <- sd(df_ratio_S$mean_ratio)/sqrt(length(df_ratio_S$mean_ratio))
...
std_error_R <- sd(df_ratio_R$mean_ratio)/sqrt(length(df_ratio_R$mean_ratio))
mean_S
mean_R
std_error_S
std_error_R
