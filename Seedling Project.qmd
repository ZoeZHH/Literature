...
There are two categories of factors that influence the carbon fluxes: abiotic (peat tempearure (Ts), water table depth (WTD)) and biotic factors (vegetation communities). Reco is closely associated with surface Ts and WTD. On a daily scale, Ts accounts for 43-74% of the variability in daily Reco, while WTD contributes to an additional 5-20% of this variability [@bubier1998a]. WTD influences the depth of the aerobic zone in the peat soil profile, exerting a more pronounced impact on Reco at seasonal scales.
...
-   ***Checking standard error of the rate of change (dc/dt) of gas concentrations**: Export the dataset and use R programming to graphically represent the standard error of dc/dt of gas concentrations for all collars (collar number as the x-axis and standard error values as the y-axis), comparing linear and exponential models. After establishing a threshold for the standard error, recompute the flux calculations for any collars that exceed this threshold.*
