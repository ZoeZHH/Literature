...
There are two categories of factors that influence the carbon fluxes: abiotic (temperature, light, water availability) and biotic factors (species composition and vegetation phenology).

There are two categories of factors that influence the carbon fluxes: abiotic (peat tempearure (Ts), water table depth (WTD)) and biotic factors (vegetation communities and phenology). Reco is closely associated with surface Ts and WTD . Extensive research indicates a positive correlation between Ts and Reco [@järveoja2018; @lloyd1994; @wang2014]; Ts explains 43-74% of daily Reco variability, with WTD accounting for an additional 5-20% [@bubier1998a]. WTD regulates the aerobic zone's depth in peat soil profiles, where a lower water table and thicker aerobic zone can increase carbon mineralization rates [@blodau2004; @frolking2011]. WTD's impact on Reco is more significant on seasonal scales [@bubier1998a].

[@blodau2004]：These studies documented that lower water tables increase C mineralization rates

[@frolking2011]: Many studies related an increase in soil temperature with an increase in ecosystem respiration;

[@bubier1998]: The bog, with lower nutrient availability has lower rates of photosynthesis and respiration.
